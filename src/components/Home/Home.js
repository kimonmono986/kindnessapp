    ...
    return (
        <div className="home-container">
            <div className="home-1">
                <strong>"Kindness" by Karyme Sanchez, Juan Cardone, &amp; Kimon Monokandilos</strong>
                <p className="home-desc">
                    ...
                    <p><strong>Target Audience - </strong>There are two tracks for the target audience. One is community cenetered - ex. Give 3 people a compliment today, Hold a door open, Pay for someone's meal. The other track is self-care oriented ex. Journal for 5 minutes, Meditate/Stretch, Be thankful for something today.</p>
